                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item ">
                            <a href="{{ URL::to('/quantri-tt') }}" class='sidebar-link'>
                                <i class="fas fa-clipboard-list" width="20px"></i>
                                <span>Quản lý thông tin chủ quán</span>
                            </a>
                    ...
                    <ul class="navbar-nav d-flex align-items-center navbar-light ml-auto">
                        ...
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown"
                                ...
                                <?php
                                $ten_qt = Session::get('quantri');
                            
                                ?>
                                <div class="d-none d-md-block d-lg-inline-block">{{ $ten_qt }} </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="{{ URL::to('/logout-quantri') }}"><i
