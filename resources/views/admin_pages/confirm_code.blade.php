        ...
        <div class="col-md-5 col-sm-12 mx-auto">
            <div class="card py-4">
                <div class="card-body">
                    ...
                    <form action="{{URL::to('/check-code-admin')}}" method="post">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="first-name-column">Nhập mã xác nhận</label>
                            <input type="text" id="first-name-column" class="form-control" name="cf_code">
                        </div>
